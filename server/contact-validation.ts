...
const BUSINESS_KEYWORDS = [
  "LLC", "L.L.C.", "INC", "CORP", "LTD", "LP", "L.P.", "LLP", "L.L.P.",
  "PLLC", "P.L.L.C.", "P.A.", "P.C.", "N.A.",
  "TRUST", "DBA", "CO.", "D/B/A",
  ...
  "PEDIATRIC", "ORTHODONT", "CHIROPRACT", "VETERINAR",
  ...
  "BANK", "BANKING", "FINANCIAL", "INSURANCE", "CREDIT UNION",
  "HOMEOWNERS", "HOA ", "CONDOMINIUM", "CONDO ", "COOPERATIVE",
  "APARTMENT", "HOUSING",
  "WAREHOUSE", "STORAGE", "LOGISTICS", "TRANSPORT", "TRANSPORTATION",
  "TRUCKING", "FREIGHT", "MOVING ",
  "WHOLESALE", "RETAIL", "DISTRIBUTION", "DISTRIBUTOR",
  "MANUFACTURING", "FABRICAT", "ENGINEERING",
  "STAFFING", "RECRUITING", "EMPLOYMENT",
  "MARKETING", "ADVERTISING", "PUBLISHING",
  "ACCOUNTING", "CPA ", "TAX ",
  "LAW FIRM", "ATTORNEY", "LEGAL SERV",
  "ARCHITECT", "SURVEYING", "EXCAVAT",
  "RECYCLING", "WASTE", "DISPOSAL", "SANITATION",
  "CEMETERY", "FUNERAL", "MORTUARY",
  "DAYCARE", "CHILDCARE", "PRESCHOOL",
  "ATHLETIC", "FITNESS", "GYM ",
  "THEATER", "THEATRE",
  "PETROLEUM", "OIL & GAS", "CHEMICAL",
  "FOODS", "CATERING", "BAKERY", "BREWERY",
  "FURNITURE", "EQUIPMENT",
  "AVIATION", "AEROSPACE",
  "COUNCIL", "BOARD OF", "COMMISSION",

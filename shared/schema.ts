...
export const leads = pgTable("leads", {
  ...
  roofAgeSource: text("roof_age_source"),
  naipEstimatedYear: integer("naip_estimated_year"),
  ...
  pipelineLastProcessedAt: timestamp("pipeline_last_processed_at"),
  pipelineRunId: text("pipeline_run_id"),
  enrichmentStatus: text("enrichment_status").default("pending"),
  landAcreage: real("land_acreage"),
  landSqft: integer("land_sqft"),
  subdivisionName: text("subdivision_name"),
  previousMarketValue: integer("previous_market_value"),
  schoolDistrict: text("school_district"),
  taxDistrict: text("tax_district"),
  deedInstrument: text("deed_instrument"),
  secondOwner: text("second_owner"),
  ownerPercentage: real("owner_percentage"),
  taxExemptions: text("tax_exemptions"),
  effectiveYearBuilt: integer("effective_year_built"),
  propertyUseDescription: text("property_use_description"),
  parcelAreaSqft: real("parcel_area_sqft"),
  dbaName: text("dba_name"),
  lastAppraisalDate: text("last_appraisal_date"),
  cadLastUpdated: timestamp("cad_last_updated"),
...
export const buildingPermits = pgTable("building_permits", {
  ...
  contractorState: text("contractor_state"),
